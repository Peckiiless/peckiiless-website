...
const Footer = () => {
      ...
      <div className="mx-auto">
        ...
        >
          <div className="flex gap-6  mt-6 xs:mt-14">
            <FadeIn className="flex gap-2 items-center">
              <svg
  ...
  <rect width="25" height="25" rx="6" fill="#B2335E"/>
  <path d="M11.4121 10.1641H13.8568V11.4169H13.8921C14.2322 10.8064 15.0645 10.1641 16.3058 10.1641C18.8865 10.1641 19.3636 11.7703 19.3636 13.8597V18.1156H16.8147V14.343C16.8147 13.4436 16.7962 12.2853 15.4895 12.2853C14.1624 12.2853 13.9592 13.2651 13.9592 14.2776V18.1156H11.4121V10.1641Z" fill="white"/>
  <path d="M6.99414 10.1641H9.64464V18.1156H6.99414V10.1641Z" fill="white"/>
  <path d="M9.64464 7.9522C9.64464 8.68374 9.05093 9.27745 8.31939 9.27745C7.58785 9.27745 6.99414 8.68374 6.99414 7.9522C6.99414 7.22066 7.58785 6.62695 8.31939 6.62695C9.05093 6.62695 9.64464 7.22066 9.64464 7.9522Z" fill="white"/>
</svg>
            ...
            <FadeIn className="flex gap-2 items-center">
              <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 25 25" fill="none">
  <rect width="25" height="25" rx="6" fill="#B2335E"/>
  <path d="M12.4984 4.60156C9.68222 4.60156 7.39844 6.7975 7.39844 9.50541C7.39844 14.4093 12.4984 20.2939 12.4984 20.2939C12.4984 20.2939 17.5984 14.4093 17.5984 9.50541C17.5984 6.7975 15.3147 4.60156 12.4984 4.60156ZM12.4984 12.4477C10.8083 12.4477 9.43844 11.1305 9.43844 9.50541C9.43844 7.88027 10.8083 6.5631 12.4984 6.5631C14.1886 6.5631 15.5584 7.88027 15.5584 9.50541C15.5584 11.1305 14.1886 12.4477 12.4984 12.4477Z" fill="white"/>
</svg>
