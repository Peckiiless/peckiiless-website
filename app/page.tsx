    ...
    <main className="px-16 mx-auto">
      <section className=" dark:bg-gray-900">
        <div className="grid py-8 px-4 mx-auto  lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
          <div className="place-self-center mr-auto lg:col-span-4">
            <p className="font-dm text-grey text-3xl  mb-6 max-w-2xl font-light  lg:mb-8 md:text-5xl lg:text-6xl dark:text-gray-400">
          ...
          <div className="place-self-center mr-auto lg:col-span-4">
            <p className=" text-grey text-3xl  max-w-2xl font-light  lg:mb-8 md:text-5xl lg:text-3xl dark:text-gray-400">
