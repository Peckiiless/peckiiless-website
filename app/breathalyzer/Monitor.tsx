      ...
      <div className="grid grid-cols-12 ">
        ...
        <div className="col-span-7">
          <div className="mb-0 md:mb-10 flex justify-center">
            <div>
              <svg
                ...
                viewBox="0 0 119 119"
                fill="none"
                className="w-[40%] md:w-[70%] h-[70%] md:h-full xl:w-full"
              >
          ...
          <div className="px-2">
            ...
            <div className="py-2">
              <Text175rem>
                Connect your Peckiiless breather device to our our application
                and observe previous and current levels.
              </Text175rem>
            </div>
          </div>
          <div className="grid grid-cols-12">
            <div className="col-span-4 flex">
              <svg
                ...
                className="h-[100%]"
              >
                <g filter="url(#filter0_d_2281_10825)">
                  <rect
                    x="23.9141"
                    y="24.4824"
                    width="53.9007"
                ...
                <defs>
                  ...
                  >
                    ...
                    <feBlend
                      mode="normal"
                      in2="BackgroundImageFix"
                      result="effect1_dropShadow_2281_10825"
                    />
                    <feBlend
                      mode="normal"
                      in="SourceGraphic"
                      in2="effect1_dropShadow_2281_10825"
                      result="shape"
                    />
                  </filter>
                </defs>
              ...
              <svg
                ...
                className="h-[100%]"
              >
                <g filter="url(#filter0_d_2281_10828)">
                  <rect
                    x="20"
                    y="20"
                    width="62"
                ...
                <defs>
                  ...
                  >
                    ...
                    <feBlend
                      mode="normal"
                      in2="BackgroundImageFix"
                      result="effect1_dropShadow_2281_10828"
                    />
                    <feBlend
                      mode="normal"
                      in="SourceGraphic"
                      in2="effect1_dropShadow_2281_10828"
                      result="shape"
                    />
                  </filter>
                </defs>
            ...
            <div className="col-span-8 flex flex-col justify-center text-[.8125rem] md:text-[1.375rem] xl:text-[1.5rem]">
              <p>Available on</p>
