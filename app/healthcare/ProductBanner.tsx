...
export default function ProductBanner() {
  return (
    <div>
      ...
      <div className="grid grid-cols-12 xl:gap-4 text-right pt-5">
        <div className="col-span-4 xs:col-span-5 ">
          ...
          <div> <p className="sm:hidden xs:text-[1.25rem] md:text-[1.75rem] text-[.875rem] pl-1">
            ...
            life.
          </p><p className="sm:hidden font-medium text-[1rem] cursor-pointer py-1">
            Read more
          </p></div>
